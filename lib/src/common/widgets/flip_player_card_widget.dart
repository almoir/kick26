      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _statTile("PAC", player.stats["pac"] ?? 0),
            _statTile("SHO", player.stats["sho"] ?? 0),
            _statTile("PAS", player.stats["pas"] ?? 0),
            _statTile("DRI", player.stats["dri"] ?? 0),
            _statTile("DEF", player.stats["def"] ?? 0),
            _statTile("PHY", player.stats["phy"] ?? 0),
          ],
        ),
      ),
    );
